                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="margin-bottom-10" id="nestable_list_menu">
                                ...
                                <a href="{{ url('menu?type=frontend') }}" class="btn btn-outline sbold uppercase"
                                   style="float: right;margin-right: 10px">Create New Menu</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">Edit : {{ $menu_data->menu_name }}
                                    menu</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            {!! Form::open(array('url'=>'menu'.'/'.$menu_data->id,'method'=>'put' , 'role' => 'form')) !!}
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">

                            <div class="uk-grid" data-uk-grid-margin>
                                <?php
                                $lang = SiteHelper::langOption();
                                $menu_lang = json_decode($menu_data->menu_lang);
                                ?>
                                    ...
                                    <div class="form-group form-md-line-input has-success">
                                        <div class="input-icon right">
                                            <input type="text" class="form-control"
                                                   ...
                                                   value="{{ @$menu_lang->title->$l['folder'] }}">
                            ...
                            <div class="form-group has-success">
                                <select id="select_demo_1" name="slug" class="bs-select form-control">
                                    ...
                                    @foreach($routes as $route)
                                        ...
                                        <option @if($menu_data->slug == $route['uri']) selected
                                                @endif value="{{ $route['uri'] }}">{{ $route['uri'].'  ( '.$route['action'] .' )'}}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-radios">
                                        ...
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="radio14" @if($menu_data->active == '1') checked
                                                       @endif name="active" value="1" class="md-radiobtn">
                                                <label for="radio14">
                                                    <span></span>
                                            ...
                                            <div class="md-radio has-error">
                                                <input type="radio" id="radio15" @if($menu_data->active == '0') checked
                                                       @endif name="active" value="0" class="md-radiobtn">
                                                <label for="radio15">
                                                    <span></span>
                                                    <span class="check"></span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-radios">
                                        ...
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="frontend" name="menu_type"
                                                       @if($menu_data->menu_type == 'frontend') checked
                                                       @endif value="frontend" class="md-radiobtn">
                                                <label for="frontend">
                                                    <span></span>
                                                    <span class="check"></span>
                                            ...
                                            <div class="md-radio has-error">
                                                <input type="radio" id="menu_type" name="menu_type"
                                                       @if($menu_data->menu_type == 'backend') checked
                                                       @endif value="backend" class="md-radiobtn">
                                                <label for="menu_type">
                                                    <span></span>
                                                    <span class="check"></span>
