    ...
    <div id="page_content">
        <div id="page_content_inner">
            <h3 class="heading_a">
                ...
                <a href="{{ url('menu') }}" class="md-btn" style="float: right;margin-right: 3px">Create New Menu</a>
            </h3>
                ...
                <div class="uk-width-3-5">
                    <div class="md-card">
                        <div class="md-card-content">
                            <h3 class="heading_a">
                                <i class="material-icons">vpn_key</i>&nbsp;&nbsp;Edit : <span class="uk-text-primary uk-margin-remove">{{ $menu_data->menu_name }}</span> menu
                            </h3>
                            <br><br>
                            {!! Form::open(array('url'=>'menu'.'/'.$menu_data->id,'method'=>'put')) !!}
                                <div class="uk-grid" data-uk-grid-margin>
                                    <?php
                                        ...
                                        <div class="uk-form-row">
                                            <select id="select_demo_1" name="slug" data-md-selectize>
                                                ...
                                                @foreach($routes as $route)
                                                    ...
                                                    <option @if($menu_data->slug == $route['uri']) selected @endif value="{{ $route['uri'] }}">{{ $route['uri'].'  ( '.$route['action'] .' )'}}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="uk-grid">
                                    ...
                                    <span class="icheck-inline">
                                        <input type="radio" @if($menu_data->active == '1') checked @endif name="active" value="1" id="enable" data-md-icheck/>
                                        <label for="enable" class="inline-label">Enable</label>
                                    </span>
                                    <span class="icheck-inline">
                                        <input type="radio" @if($menu_data->active == '0') checked @endif name="active" value="0" id="disable" data-md-icheck/>
                                    ...
                                    <div class="uk-width-medium-1-2">
                                        <div class="uk-form-row">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin="">
                                                <div class="uk-width-medium-1-1">
                                    <span class="icheck-inline">
                                        <input type="radio" @if($menu_data->menu_type == 'frontend') checked @endif name="menu_type" value="frontend" id="Frontend" data-md-icheck/>
                                        <label for="Frontend" class="inline-label">Frontend</label>
                                    </span>
                                    <span class="icheck-inline">
                                        <input type="radio" @if($menu_data->menu_type == 'backend') checked @endif name="menu_type" value="backend" id="Backend" data-md-icheck/>
