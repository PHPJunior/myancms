                    ...
                    <div class="card">
                        <div class="card-content">
                            <form action="{{ url('install/saveSetting') }}" style="padding: 0px 30px;" method="post" id="form_validation"
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <h5 class="left-align"><i class="material-icons">settings</i>&nbsp;&nbsp;SITE SETTINGS
                                        </h5>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <textarea name="site_metadesc" id="site_metadesc" class="materialize-textarea"></textarea>
                                ...
                                <div class="row center">
                                    <div class="col s12 m4 offset-m4">
                                        <button style="width:100%;" type="submit" class=" btn-large btn-block red waves-attach waves-light">SUBMIT SETTINGS</button>
                                    </div>
                                </div>
                            </form>
                        </div>
